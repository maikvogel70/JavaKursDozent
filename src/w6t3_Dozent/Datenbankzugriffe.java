...
//				{
//
//					// Schriftfarbe außerhalb des Fortschrittbalkens
//					@Override
...
//				});
	...
	private void readFile(String Dateiname)
	{
		...
		if (recordCount > 0)
		{
			...
			dlgValue = JOptionPane.showOptionDialog(this, "Sollen die Einträge der vorhandenen Tabelle der Postleitzahlen vorher gelöscht werden", "Frage",
