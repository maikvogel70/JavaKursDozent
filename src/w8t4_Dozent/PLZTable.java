...
public class PLZTable extends JDialog implements ActionListener, WindowListener, ListSelectionListener, KeyListener, MouseListener
{
	...
	private void initializeComponents()
	{
		...
		miXML = Globals.createMenuItem(menuDatei, Globals.MenuItemType.ITEM_PLAIN, "XML", null, 'X', null);
		miXML.addActionListener(this);
		
		menuDatei.addSeparator();
		
		miSchliessen = Globals.createMenuItem(menuDatei, Globals.MenuItemType.ITEM_PLAIN, "Schließen", null, 'S', null);
		miSchliessen.addActionListener(this);
		
		menuBearbeiten = new JMenu("Bearbeiten");
		menuBearbeiten.setMnemonic('B');
		menuBar.add(menuBearbeiten);
		
		miNeu = Globals.createMenuItem(menuBearbeiten, Globals.MenuItemType.ITEM_PLAIN, "Neu", null, 'N', null);
		miNeu.addActionListener(this);
		
		miAendern = Globals.createMenuItem(menuBearbeiten,  Globals.MenuItemType.ITEM_PLAIN, "Ändern", null, 'Ä', null);
		miAendern.addActionListener(this);
		
		miLoeschen = Globals.createMenuItem(menuBearbeiten,Globals.MenuItemType.ITEM_PLAIN, "Löschen", null, 'L', null);
		...
		miSuchePLZ = Globals.createMenuItem(menuSuchen, Globals.MenuItemType.ITEM_PLAIN, "Postleitzahlen", null, 'P', null);
		miSuchePLZ.addActionListener(this);
		miSucheOrt = Globals.createMenuItem(menuSuchen, Globals.MenuItemType.ITEM_PLAIN, "Ort", null, 'O', null);
		miSucheOrt.addActionListener(this);	
		...
		// Listener zur Anzeige der aktuellen Zeilennummer
		 ...
		 // Automatisches Sortieren (aufsteigend/absteigend). wenn auf
		 // die Spaltenüberschrift der Spalte geklickt wurde.
	...
	private class PLZTableModel extends AbstractTableModel
	{
		...
		public PLZTableModel()
		{
			...
			// Lesen der Metadaten: Anzahl, Datentypen und Eigenschaften (Namen) der Spalten
...
//				}
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		{
			TableColumnModel tableColumnModel = Tabelle.getColumnModel();
			int selColumn = tableColumnModel.getColumnIndexAtX(e.getX());  //gets the selected column by clicked x coordinate
		}
    }
